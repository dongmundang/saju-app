...
function buildPrompt(topic, sajuText, extra, age) {
  ...
  const sections = {
    ...
    '연애': isMinor ? [
      ...
      '### 친구를 사귀는 방식\n타고난 대인관계 성향, 마음을 여는 방식, 또래에게 어떻게 비치는지. 도화살·홍염 등이 있으면 사람을 끄는 매력으로 풀이. (5~6문장)',
      '### 잘 맞는 친구와 관계의 특징\n비겁·식상 등으로 본 잘 맞는 친구 유형과 관계 맺는 방식. (5~6문장)',
      '### 자라면서 관계에서 주의할 점\n친구·또래 관계에서 반복되기 쉬운 패턴과 그 이유, 부드럽게. 연애·결혼·이성 관계 언급은 하지 말 것. (4~5문장)',
      '### 상담가의 조언\n좋은 친구 관계를 맺도록 돕는 구체적 조언 3가지. (3~4문장)'
    ] : [
      '### 한눈에 보는 요약\n연애·결혼운의 핵심을 3줄로.',
    ...
    '재물': isMinor ? [
      ...
      '### 타고난 재물 그릇\n재성의 유무와 위치로 본, 이 사람이 자라서 가지게 될 돈에 대한 태도와 그릇. 지금 돈을 벌거나 관리한다고 서술하지 말 것. (5~6문장)',
      '### 앞으로 잘 맞을 분야\n십신·오행·신살로 본 적성과 자라서 살릴 수 있는 재능 분야를 구체적으로. (5~6문장)',
      '### 자라면서 도움이 되는 습관\n용신 오행을 살리는 생활 습관이나 부모가 지금부터 도와줄 수 있는 방향. (4~5문장)',
      '### 상담가의 조언\n아이의 재능과 재물 그릇을 잘 키워주기 위해 부모님께 드리는 조언 3가지. (3~4문장)'
    ] : [
      '### 한눈에 보는 요약\n재물·직업운의 핵심을 3줄로.',
